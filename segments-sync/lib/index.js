...
function getActionContext() {
  ...
  const segmentsPathInRepo = core.getInput('segments_path');
  const segmentsApiEndpoint = core.getInput('segments_api_endpoint');
  const sandboxName = core.getInput('sandbox_name');
